...
@section('content')
    ...
    <div class="px-15 my-10 ">
        <div class="flex max-md:flex-col  mb-10 md:h-125">
            <div
                class="border-b border-black/10 overflow-hidden  w-full h-125 md:w-2/5 bg-[url({{ asset($product->images) }})] bg-no-repeat bg-cover bg-center">
            </div>
            <div class=" flex flex-col justify-around md:w-3/5  px-5 ">
                ...
                <form action="" method="POST" class="h-40 flex flex-col">
                    ...
                    <div class="flex">
                        <button class="text-6xl bg-amber-200 size-10 text-center content-center" id="minusbtn">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                            </svg>
                        </button>
                        <div class="number w-20 bg-gray-200 h-10 text-2xl font-bold text-center content-center"
                            id="number">1</div>
                        <button class="text-5xl bg-amber-200 size-10 text-center content-center" id="plusbtn">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                        </button>
                        <button type="submit" class="capitalize h-10 px-5 mx-5 font-bold text-center bg-amber-200">Add to
                            cart</button>
                    </div>
                </form>
    ...
    <div class="info-about-product px-15">
        <div class="button flex justify-center border border-white border-b-gray-500">
            <button type="submit"
                class="w-40 px-6 py-3 detailsbtn text-amber-400 font-bold text-center border border-white focus:border-gray-500 focus:border-b-white focus:text-gray-500 ">description</button>
            <button type="submit"
                class="w-40 px-6 py-3 detailsbtn text-amber-400 font-bold text-center border border-white focus:border-gray-500 focus:border-b-white focus:text-gray-500 ">information</button>
            <button type="submit"
        ...
        <div class="info my-10 ">
            <div class="child description hidden">
                ...
                <p class="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium consequatur
                    ...
                    laudantium cumque totam repellat, distinctio hic? Pariatur, placeat!lorem
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea, inventore dolorem explicabo, ducimus labore
                    consectetur illo reprehenderit reiciendis animi consequatur, cupiditate sequi cum temporibus nisi
                    suscipit ab aut architecto unde.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium consequatur accusamus, veniam,
                    quisquam facere suscipit architecto voluptas tenetur sit nostrum dolorem perferendis laudantium cumque
                    totam repellat, distinctio hic? Pariatur, placeat!lorem
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea, inventore dolorem explicabo, ducimus labore
                    consectetur illo reprehenderit reiciendis animi consequatur, cupiditate sequi cum temporibus nisi
                    suscipit ab aut architecto unde.
                </p>
            ...
            <div class="child reviews flex max-md:flex-col gap-5 w-full">
                    ...
                    <div class="flex flex-col">
                        <div class="one flex gap-5 my-5">
                            ...
                            <div class="w-9/10 flex flex-col">
                                ...
                                <p class="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique,
                                    maxime enim! Alias illo, voluptatem est consequuntur necessitatibus voluptatibus eos
                                    quidem! Commodi sed quibusdam, voluptas dolore ea provident deleniti velit quos?</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="add-review md:w-1/2 w-full ">
                    ...
                    <form action="" class="w-full flex flex-col">
                        <h1 class="text-gray-500 text-sm my-5">Your email address will not be published. Required fields are
                            marked *</h1>
                        <div class="flex mb-5">
                        ...
                        <textarea type="textaria" name="Message" id="review"
                            class="w-full px-6 py-3 text-xl font-bold text-gray-600/50 border border-black/10 mb-5"></textarea>
                        <label for="name" class="text-xl text-gray-500">
                            your name *
                        </label>
                        <input type="text" name="name" id="name"
                            class="w-full px-6 py-3 text-xl font-bold text-gray-600/50 border border-black/10 mb-5">
