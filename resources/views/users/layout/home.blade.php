...
<div class="flex mb-5 mr-10 ">
   <div class="w-1/4"></div>
   <div class="slider  w-3/4  h-100 overflow-hidden flex flex-row justify-between items-center" id="slider">
...
<div class="servies grid grid-cols-4 gap-2 font-black  text-xl ">
   <div class="quality-product flex border border-black/20  mx-3 py-10 justify-center items-center">
      <div class="">
   ...
   <div class="Free-Shipping flex border border-black/20 mx-3 py-10 justify-center items-center">
      <div class="">
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
   ...
   <div class="q14-Day-Return flex border border-black/20 mx-3 py-10 justify-center items-center ">
      <div class="">
   ...
   <div class="Support flex border border-black/20 ml-3 py-10 justify-center items-center ">
      <div class="">
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
