...
@section('content')
    <div class="flex mb-5 lg:mr-10 ">
        ...
        <div class="slider  w-full  lg:w-3/4  h-100 overflow-hidden flex flex-row justify-between items-center" id="slider"
            ...
            <div class="back-next-btn text-white px-4 cursor-pointer" data-btn="back"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
                </svg>
            </div>
            <div class="back-next-btn text-white px-4 cursor-pointer" data-btn="next"><svg xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
    ...
    <div class="updates w-full bg-blue-200 py-15 text-center ">
        ...
        <div class="sm:w-2/3 sm:px-0 px-5 mx-auto text-black/70 font-bold">
            ...
            <form action="" class="w-full  mt-10 flex  items-center">
                <input type="text" placeholder="Email Gose Here" class="py-3 px-6 w-lg outline-none h-10 bg-white"
                    placeholder="searsh">
    ...
    <div class="sponser my-30">
        <div class="flex w-full overflow-x-scroll overflow-y-hidden ">
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-2.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-1.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-3.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-4.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-5.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-6.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-7.jpg') }}
                    alt="" class="size-35 "></div>
            <div class="size-35 flex-none border border-black/20 mx-5 "><img src={{ asset('img/vendor-8.jpg') }}
                    alt="" class="size-35 "></div>
        </div>
    </div>
@endsection
