   ...
   <div class="navbar lg:flex block items-center">
      ...
      <div class="md:flex w-full justify-between items-center px-5">
         <div class="w-full md:w-6/10  flex justify-center">
            <form action="{{route('search')}}" method="GET" class="flex w-full border border-black/20 items-center">
               @csrf
         ...
         <div class="cart-likes flex justify-center sm:justify-around items-center gap-5 md:w-auto">
            <div class="likes">
               <div class="cursor-pointer  h-10 flex justify-center items-center px-2 py-1 rounded border border-black/20">
            ...
            <div class="cart-btn h-10 relative ml-3 flex " id="cart-btn">
                  ...
                  <div class="cart-detail w-auto min-h-20 max-h-100 overflow-y-scroll bg-blue-300 border border-2 border-gray-500 overflow-hidden rounded-lg absolute hidden block -right-46 max-md:top-15 md:right-20 " id="cart-detail">
                     <table class="">
                        <thead>
...
<div class="">
   <div class="flex justify-between">
      ...
      <div class="navbar  flex justify-between  text-lg mx-5 w-full lg:w-3/4">
