<div class="w-full h-100 capitalize bg-blue-200 px-10 mt-10">
   <div class="grid grid-cols-3 gap-5 h-3/4 pt-20">
      <div class="px-4">
         ...
         <p class="text-gray-500 font-bold my-5">Dolore erat dolor sit lorem vero amet. Sed sit lorem magna, ipsum no sit erat lorem et magna ipsum dolore amet erat.</p>
      ...
      <div class="Newsletter mx-auto w-70">
         ...
         <form class="flex flex-col justify-around h-50  " action="">
            ...
            <input type="email" class="w-full h-15 bg-stone-100 p-3 outline-none" placeholder="your email">
            <button type="submit" class="bg-red-500 w-full h-15 p-3">Sub Now</button>
         </form>
      </div>
   </div>
</div>
