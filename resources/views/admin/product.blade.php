...
@section('content')
   ...
   <div class="main_dashboard w-6/8 mx-2 overflow-x-auto">
      <a href="{{route('create_product')}}" class="text-white bg-blue-500 px-6 px-3 rounded mb-3">create</a>
         ...
         <tbody>
            <tr>
               ...
               <td class="px-3 py-1 text-center border border-black/20">
                  <div class="flex">
                        <a href="{{route('show_product' , [$product->id])}}" class="px-3 py-1 mx-1 bg-blue-500 text-white rounded">show</a>
                        <a href="{{route('edit_product' , [$product->id])}}" class="px-3 py-1 mx-1 bg-black text-white rounded">edit</a>
                     <form action="">
